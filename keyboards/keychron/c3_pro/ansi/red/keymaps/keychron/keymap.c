...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_BASE] = LAYOUT_tkl_ansi(
        ...
        CTL_T(KC_DEL),  KC_A,     KC_S,     KC_D,     KC_F,     KC_COMM,     KC_DOT,     KC_N,     KC_M,     KC_L,     LT(MAC_BASE, KC_X),  KC_QUOT,              KC_ENT,
    ...
    [WIN_FN] = LAYOUT_tkl_ansi(
        ...
        BL_TOGG,  BL_STEP,  KC_WH_D,    KC_MS_U,  KC_WH_U,  _______,  _______,  _______,  KC_BTN3,  KC_BTN5,  KC_BTN4,  _______,  _______,    _______,  _______,  KC_OSSW,  QK_BOOT,
