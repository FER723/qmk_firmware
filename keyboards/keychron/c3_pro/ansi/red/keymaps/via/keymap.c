...
const uint16_t PROGMEM od_combo[] = {KC_O, KC_D, COMBO_END};
const uint16_t PROGMEM ed_combo[] = {KC_E, KC_D, COMBO_END};

combo_t key_combos[COMBO_COUNT] = {
  [OD_ESC] = COMBO(od_combo, KC_ESC),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_tkl_ansi(
        ...
        BL_TOGG,  BL_STEP,  BL_UP,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  QK_BOOT,
